 ...
 **/
@Configuration
public class KnowledgeConfigure {
     ...
     * @date 2022/7/7 16:18
     **/
    @Bean(value = "knowledgeDocApi")
    public Docket knowledgeDocApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.kiteehub.knowledge"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions("知识库功能"));
    }
}
