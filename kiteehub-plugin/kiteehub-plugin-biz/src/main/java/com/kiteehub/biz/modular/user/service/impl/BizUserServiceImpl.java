 ...
 */
package com.kiteehub.biz.modular.user.service.impl;
...
import com.kiteehub.biz.core.enums.BizBuildInEnum;
...
import com.kiteehub.biz.modular.user.enums.BizUserStatusEnum;
import com.kiteehub.biz.modular.user.mapper.BizUserMapper;
...
import com.kiteehub.biz.modular.user.result.BizUserExportResult;
...
public class BizUserServiceImpl extends ServiceImpl<BizUserMapper, BizUser> implements BizUserService {
    ...
    public void add(BizUserAddParam bizUserAddParam) {
        ...
        // 设置密码
        bizUser.setPassword(CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(KITEE_SYS_DEFAULT_PASSWORD_KEY)));
        // 设置状态
    ...
    public void exportUser(BizUserExportParam bizUserExportParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String fileName = "KiteeHub2.0系统B端人员信息清单.xlsx";
    ...
    public void exportUserInfo(BizUserIdParam bizUserIdParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // 生成临时导出文件
            resultFile = FileUtil.file(FileUtil.getTmpDir() + File.separator + "KiteeHub2.0系统B端人员信息_" + bizUser.getName() + ".docx");
            // 写入
