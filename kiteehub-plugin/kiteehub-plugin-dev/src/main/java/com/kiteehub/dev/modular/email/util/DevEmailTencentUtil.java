...
public class DevEmailTencentUtil {
    ...
    private static final String KITEE_EMAIL_TENCENT_SECRET_ID_KEY = "KITEE_EMAIL_TENCENT_SECRET_ID";
    private static final String KITEE_EMAIL_TENCENT_SECRET_KEY_KEY = "KITEE_EMAIL_TENCENT_SECRET_KEY";
    private static final String KITEE_EMAIL_TENCENT_REGION_ID_KEY = "KITEE_EMAIL_TENCENT_REGION_ID";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(KITEE_EMAIL_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(KITEE_EMAIL_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(KITEE_EMAIL_TENCENT_REGION_ID_KEY);
