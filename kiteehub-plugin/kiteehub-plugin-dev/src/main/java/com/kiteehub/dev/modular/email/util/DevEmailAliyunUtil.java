...
public class DevEmailAliyunUtil {
    ...
    private static final String KITEE_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY = "KITEE_EMAIL_ALIYUN_ACCESS_KEY_ID";
    private static final String KITEE_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY = "KITEE_EMAIL_ALIYUN_ACCESS_KEY_SECRET";
    private static final String KITEE_EMAIL_ALIYUN_REGION_ID_KEY = "KITEE_EMAIL_ALIYUN_REGION_ID";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(KITEE_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(KITEE_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(KITEE_EMAIL_ALIYUN_REGION_ID_KEY);
