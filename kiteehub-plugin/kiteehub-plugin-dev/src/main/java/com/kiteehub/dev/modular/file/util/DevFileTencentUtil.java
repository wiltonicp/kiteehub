...
public class DevFileTencentUtil {
    ...
    private static final String KITEE_FILE_TENCENT_SECRET_ID_KEY = "KITEE_FILE_TENCENT_SECRET_ID";
    private static final String KITEE_FILE_TENCENT_SECRET_KEY_KEY = "KITEE_FILE_TENCENT_SECRET_KEY";
    private static final String KITEE_FILE_TENCENT_REGION_ID_KEY = "KITEE_FILE_TENCENT_REGION_ID";
    private static final String KITEE_FILE_TENCENT_DEFAULT_BUCKET_NAME = "KITEE_FILE_TENCENT_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(KITEE_FILE_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(KITEE_FILE_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(KITEE_FILE_TENCENT_REGION_ID_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(KITEE_FILE_TENCENT_DEFAULT_BUCKET_NAME);
