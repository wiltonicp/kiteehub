 ...
 */
package com.kiteehub.dev.modular.file.util;
...
import com.kiteehub.dev.modular.file.enums.DevFileBucketAuthEnum;
...
public class DevFileMinIoUtil {
    ...
    private static final String KITEE_FILE_MINIO_ACCESS_KEY_KEY = "KITEE_FILE_MINIO_ACCESS_KEY";
    private static final String KITEE_FILE_MINIO_SECRET_KEY_KEY = "KITEE_FILE_MINIO_SECRET_KEY";
    private static final String KITEE_FILE_MINIO_END_POINT_KEY = "KITEE_FILE_MINIO_END_POINT";
    private static final String KITEE_FILE_MINIO_DEFAULT_BUCKET_NAME = "KITEE_FILE_MINIO_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* accessKey */
        String accessKey = devConfigApi.getValueByKey(KITEE_FILE_MINIO_ACCESS_KEY_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(KITEE_FILE_MINIO_SECRET_KEY_KEY);
        ...
        /* endpoint */
        String endpoint = devConfigApi.getValueByKey(KITEE_FILE_MINIO_END_POINT_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(KITEE_FILE_MINIO_DEFAULT_BUCKET_NAME);
    ...
    public static String getFileAuthUrl(String bucketName, String key) {
        try {
            initClient();
            DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
            return devConfigApi.getValueByKey(KITEE_FILE_MINIO_END_POINT_KEY) + StrUtil.SLASH + bucketName + StrUtil.SLASH + key;
        } catch (Exception e) {
            throw new CommonException(e.getMessage());
        }
    }
