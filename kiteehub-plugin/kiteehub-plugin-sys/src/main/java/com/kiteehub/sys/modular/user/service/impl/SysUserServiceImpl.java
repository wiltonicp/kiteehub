 ...
 */
package com.kiteehub.sys.modular.user.service.impl;
...
import com.kiteehub.common.excel.CommonExcelCustomMergeStrategy;
...
import com.kiteehub.mobile.api.MobileButtonApi;
import com.kiteehub.mobile.api.MobileMenuApi;
...
import com.kiteehub.sys.modular.role.enums.SysRoleDataScopeCategoryEnum;
...
import com.kiteehub.sys.modular.user.mapper.SysUserMapper;
import com.kiteehub.sys.modular.user.param.*;
import com.kiteehub.sys.modular.user.result.*;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    private static final String KITEE_SYS_DEFAULT_WORKBENCH_DATA_KEY = "KITEE_SYS_DEFAULT_WORKBENCH_DATA";
    ...
    public void add(SysUserAddParam sysUserAddParam) {
        ...
        // 设置默认密码
        sysUser.setPassword(CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(KITEE_SYS_DEFAULT_PASSWORD_KEY)));
        // 设置状态
    ...
    public void resetPassword(SysUserIdParam sysUserIdParam) {
        this.update(new LambdaUpdateWrapper<SysUser>().eq(SysUser::getId,
                ...
                CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(KITEE_SYS_DEFAULT_PASSWORD_KEY))));
    }
    ...
    public String loginWorkbench(SysUserIdParam sysUserIdParam) {
        ...
        return devConfigApi.getValueByKey(KITEE_SYS_DEFAULT_WORKBENCH_DATA_KEY);
    }
    ...
    public void downloadImportUserTemplate(HttpServletResponse response) throws IOException {
        try {
            ...
            CommonDownloadUtil.download("KiteeHub2.0系统B端用户导入模板.xlsx", bytes, response);
        } catch (Exception e) {
    ...
    public void exportUser(SysUserExportParam sysUserExportParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String fileName = "KiteeHub2.0系统B端用户信息清单.xlsx";
    ...
    public void exportUserInfo(SysUserIdParam sysUserIdParam, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // 生成临时导出文件
            resultFile = FileUtil.file(FileUtil.getTmpDir() + File.separator + "KiteeHub2.0系统B端用户信息_" + sysUser.getName() + ".docx");
            // 写入
